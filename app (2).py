...
div[data-testid="stDataFrame"] { border-radius: 12px; overflow: hidden; border: 1px solid #EADFC7; }

.stButton > button, .stFormSubmitButton > button {
    background-color: #5A3A22; color: #FBF6EC; border-radius: 10px; border: none;
    font-weight: 700;
}
.stButton > button:hover, .stFormSubmitButton > button:hover { background-color: #7A5236; color: #FBF6EC; }

div[data-testid="stExpander"] { border: 1px solid #EADFC7; border-radius: 12px; }
</style>
